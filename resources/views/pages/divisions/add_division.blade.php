<x-app-layout>
    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div
                class="bg-white overflow-hiddenshadow-lg shadow-cyan-500/50 dark:shadow-lg dark:shadow-cyan-800/80 sm:rounded-lg">
                    ...
                    <form action="{{ route('divisions.store') }}" method="POST">
                        ...
                        <div class="grid grid-cols-1  md:grid-cols-1 my-6 ">
                            ...
                            <font style="color: red">
                                {{ $errors->has('division_name') ? $errors->first('division_name') : ' ' }}</font>
